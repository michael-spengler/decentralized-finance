...
class ERC20Service {
    static async getBalanceOfERC20TokenInWallet(walletAddress, walletPrivateKey, tokenAddress) {
    ...
    static async getBalanceOfcETHInWallet(walletAddress, walletPrivateKey) {
