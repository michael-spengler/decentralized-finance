export declare class ERC20Service {
    ...
    static getBalanceOfBATInWallet(walletAddress: string, walletPrivateKey: string, web3ProviderURL: string): Promise<number>;
    static getBalanceOfLINKInWallet(walletAddress: string, walletPrivateKey: string, web3ProviderURL: string): Promise<number>;
}
