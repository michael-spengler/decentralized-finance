...
export class PortfolioProvider {
    ...
    private preparePortfolioList() {
        ...
        this.portfolio.push({ pairName: "TRXUSDT", percentage: 3, decimalPlaces: 0 })
        this.portfolio.push({ pairName: "VETUSDT", percentage: 3, decimalPlaces: 0 })
        this.portfolio.push({ pairName: "XLMUSDT", percentage: 3, decimalPlaces: 0 })
        this.portfolio.push({ pairName: "AAVEUSDT", percentage: 3, decimalPlaces: 1 })
        this.portfolio.push({ pairName: "BATUSDT", percentage: 3, decimalPlaces: 1 })
        this.portfolio.push({ pairName: "DOTUSDT", percentage: 3, decimalPlaces: 1 })
        this.portfolio.push({ pairName: "FILUSDT", percentage: 3, decimalPlaces: 1 })
        this.portfolio.push({ pairName: "LINKUSDT", percentage: 3, decimalPlaces: 2 })
        this.portfolio.push({ pairName: "LTCUSDT", percentage: 3, decimalPlaces: 2 })
