import { ShortScamsStrategy } from "./short-scams"
...
const goWithTheFlow = new ShortScamsStrategy(pair, tradeUnitSize, minValAtRisk, factor, buyPauseAfterSale, binanceApiKey, binanceApiSecret)
